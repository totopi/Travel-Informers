// If we do it on two different pages, copy the select populations to a second page or whatever
...
let initCity = document.querySelector('#initCity').innerHTML;
let initMonth = document.querySelector('#initMonth').innerHTML;
let initType = document.querySelector('#initType').innerHTML;
let url = `/${initCity}/${initMonth}/${initType}`;
